...
ASSEMBLED_OUTPUT="${1:-$ROOT_DIR/doc/LINSYSTEM.md}"
...
require_contains "$PARTS_DIR/_index.md" "**Designation:** LIN" "index designation"
require_contains "$PARTS_DIR/_index.md" "BDS Documentation Protocol v2.0" "index protocol"
require_contains "$PARTS_DIR/_index.md" 'Primary output: `doc/LINSYSTEM.md`' "index primary output"
require_contains "$PARTS_DIR/BUILD.sh" 'DESIGNATION="LIN"' "build designation"
...
require_contains "$ASSEMBLED_OUTPUT" "**Designation:** LIN" "assembled designation"
require_contains "$ASSEMBLED_OUTPUT" 'Primary output: `doc/LINSYSTEM.md`' "assembled primary output"
